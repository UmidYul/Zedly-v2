...
class ErrorCode(str, Enum):
    ...
    CLASS_LIMIT_REACHED = "CLASS_LIMIT_REACHED"
    ONBOARDING_TOKEN_INVALID = "ONBOARDING_TOKEN_INVALID"
    TELEGRAM_HASH_INVALID = "TELEGRAM_HASH_INVALID"
    TELEGRAM_AUTH_EXPIRED = "TELEGRAM_AUTH_EXPIRED"
    TEST_ALREADY_ASSIGNED = "TEST_ALREADY_ASSIGNED"
    SESSION_ALREADY_EXISTS = "SESSION_ALREADY_EXISTS"
    SESSION_EXPIRED = "SESSION_EXPIRED"
    NTT_OFFLINE_FORBIDDEN = "NTT_OFFLINE_FORBIDDEN"
